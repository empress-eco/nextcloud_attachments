...
app_name = "attachments_on_nextcloud"
app_title = "Attachments on Nextcloud"
app_publisher = "Grynn GMBH"
app_description = "Grynn App for NextCloud Backup"
app_icon = "octicon octicon-file-directory"
app_color = "grey"
app_email = "deepakpai@gmail.com"
app_license = "MIT"
...
doc_events = {
    "*": {
        "on_submit": "attachments_on_nextcloud.save_pdf.save_pdf"
    },
    "File": {
        "after_insert": "attachments_on_nextcloud.nextcloud.save_to_nextcloud",
    }
}
...
scheduler_events = {
    ...
    # 	],
    "daily": [
        "attachments_on_nextcloud.nextcloud_integration.doctype.nextcloud_setting.nextcloud_setting.daily_backup"
    ],
    # 	"hourly": [
    # 		"nextcloud_integration.tasks.hourly"
    # 	],
    "weekly": [
        "attachments_on_nextcloud.nextcloud_integration.doctype.nextcloud_setting.nextcloud_setting.weekly_backup"
    ],
    # 	"monthly": [
